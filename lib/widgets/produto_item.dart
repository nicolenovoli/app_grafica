...
class ProdutoItem extends StatefulWidget {
  ...
  const ProdutoItem({super.key, required this.produto});
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) => ProductDetailsPage(produto: widget.produto),
              ),
            );
          },
                ...
                child: SizedBox(
                  ...
                  child: Image.asset(
                    widget.produto.nome == "Cartões de Visita"
                        ...
                        ? "assets/folder.jpg"
                        : widget.produto.nome == "Etiquetas Adesivas"
                        ? "assets/etiqueta.jpeg"
                        : widget.produto.nome == "Receituário Médico"
